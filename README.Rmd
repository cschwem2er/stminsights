...
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/stminsights?color=orange)](https://cran.rstudio.com/web/packages/stminsights/index.html)
...
You can then upload an `.RData` file which should include:
...
Deploying stminsights to your own shiny server is pretty simple: Place the file `app.R`, 
which is located at `inst/app` of this package, to a folder in your server directory
